...
parser.add_argument('--refine_starting_epoch', type=int, default=40, help='the interval of refinement')
...
parser.add_argument('--interm_start_epoch', type=int, default=0, help='epoch to starting interm')
parser.add_argument('--num_interm_features', type=int, default=2, help='number of features')
parser.add_argument('--interm_flag', type=bool, default=False, help='Whether 1- is required')
