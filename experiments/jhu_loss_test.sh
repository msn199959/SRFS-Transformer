...
--dataset jhu --crop_size 256 --pre ./save_file/log_file/20231211_172832/model_best.pth --test_patch --save \
--starting_epoch 50 --refine_interval 5 --refine_replace True --encoder_interm_supervise
